...
fn build_report(
    ...
    Report {
        ...
        limits: vec![
            ...
            "Fixed-width wallet signing vectors are generated by crates/cellscript-tools/src/wallet_vectors.rs and checked by the production gate; this harness verifies resolved transaction semantics.",
