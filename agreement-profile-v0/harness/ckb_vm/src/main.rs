...
fn build_report(
    ...
    Report {
        ...
        limits: vec![
            ...
            "Fixed-width wallet signing vectors are generated by crates/cellscript-tools/src/wallet_vectors.rs; this legacy action harness does not consume wallet UX artefacts.",
